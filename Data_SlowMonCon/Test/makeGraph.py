...
import HvPackages.dataFunctions
...
# Read files
fDT = open("testDifferenceTracker.dat")
fPV = open("testPickOffVoltage.dat")
fCM = open("testCurrMon.dat")
fRoot = ROOT.TFile("testDT_PV_CM.root","RECREATE")
fDT.readline()
fPV.readline()
fCM.readline()
valDT = array.array("d",[])
